    ...
    return(
        <nav className="flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20">
            ...
            <ul className={`${menu? "block":"hidden"} mx-24 py-2 mt-4 font-semibold md:mt-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6`}>
                <a href="#About">
                    <li className="text-md transition-all duration-300 p-1 md:p-0 hover:cursor-pointer">About</li>
                </a>
                <a href="#Projects">
                    <li className="text-md transition-all duration-300 p-1 md:p-0 hover:cursor-pointer">Projects</li>
                </a>
                <a href="#Resume">
                    <li className="text-md transition-all duration-300 p-1 md:p-0 hover:cursor-pointer">Resume</li>
                </a>
                <a href="#Footer">
                    <li className="text-md transition-all duration-300 p-1 md:p-0 hover:cursor-pointer">Contact</li>
                </a>
            </ul>
            {showMenu? (
