  ...
  return (
    <div id="Projects" className='p-10 md:p-24 text-white'>
        ...
        <div className='py-12 px-8 flex flex-wrap gap-5'>
            ...
            <ProjectCard title="Crypto Price Website" Demo="https://sdivyasravani.github.io/Crypto_Price/" code="https://github.com/SDivyaSravani/Crypto_Price" main="Using react , Tailwind" banner="" />
